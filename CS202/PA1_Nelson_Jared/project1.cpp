//THIS PROGRAM BRINGS IN TEXT FILE FROM USER SORTS BY LENGTH AND ALPHABETICAL ORDER THEN PRINTS TO CONSOLE AND WRITES NEW TEXT FILE CONTAINING NEW SORTED ORDERS
#include <iostream>
#include <fstream>
using namespace std;
